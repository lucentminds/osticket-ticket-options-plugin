...
var build = module.exports = function( bob ){ // jshint ignore:line
   ...
   var onBuildFail = function( /*err*/ ){
      console.log( 'Failed to build ui-error-banner!' );
      console.log( '\n\n' );
   };// /onBuildFail()
   ...
   oJobBuild.addTask( 'jsify', function(){
      // Jsify and minify.
      return jsify( bob.resolve( './src/ui-error-banner.htm' ), true )
      .then(function( cResult ){
         ...
         return write( bob.resolve( './temp/ui-error-banner-htm.js' ), cJs );
      });
   });
   ...
   oJobBuild.addTask( 'concat', function(){
      ...
      return Q.all([
         ...
         copy( bob.resolve('./src/ui-error-banner.css' ), bob.resolve( './build' ) ),



         concat( [

            bob.resolve( './temp/ui-error-banner-htm.js' ),
            bob.resolve( './src/ui-error-banner.js' ),
         ], bob.resolve( './build/ui-error-banner.js' ), {
