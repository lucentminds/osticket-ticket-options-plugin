...
var build = module.exports = function( bob ){ // jshint ignore:line
   ...
   var onBuildFail = function( /*err*/ ){
      console.log( 'Failed to build ui-dialog-confirm!' );
      console.log( '\n\n' );
   };// /onBuildFail()
   ...
   oJobBuild.addTask( 'jsify', function(){
      // Jsify and minify.
      return jsify( bob.resolve( './src/ui-dialog-confirm.htm' ), true )
      .then(function( cResult ){
         ...
         return write( bob.resolve( './temp/ui-dialog-confirm-htm.js' ), cJs );
      });
   });
   ...
   oJobBuild.addTask( 'concat', function(){
      ...
      return Q.all([
         ...
         copy( bob.resolve('./src/ui-dialog-confirm.css' ), bob.resolve( './build' ) ),



         concat( [

            bob.resolve( './temp/ui-dialog-confirm-htm.js' ),
            bob.resolve( './src/ui-dialog-confirm.js' ),
         ], bob.resolve( './build/ui-dialog-confirm.js' ), {
