...
var build = module.exports = function( bob ){ // jshint ignore:line
   ...
   var onBuildFail = function( /*err*/ ){
      console.log( 'Failed to build ui-show-agent-remove!' );
      console.log( '\n\n' );
   };// /onBuildFail()
   ...
   oJobBuild.addTask( 'jsify', function(){
      // Jsify and minify.
      return jsify( bob.resolve( './src/ui-show-agent-remove.htm' ), true )
      .then(function( cResult ){
         ...
         return write( bob.resolve( './temp/ui-show-agent-remove-htm.js' ), cJs );
      });
   });
   ...
   oJobBuild.addTask( 'concat', function(){
      ...
      return Q.all([
         ...
         copy( bob.resolve('./src/ui-show-agent-remove.css' ), bob.resolve( './build' ) ),



         concat( [

            bob.resolve( './temp/ui-show-agent-remove-htm.js' ),
            bob.resolve( './src/ui-show-agent-remove.js' ),
         ], bob.resolve( './build/ui-show-agent-remove.js' ), {
