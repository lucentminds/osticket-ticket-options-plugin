...
var build = module.exports = function( bob ){ // jshint ignore:line
   ...
   var onBuildFail = function( /*err*/ ){
      console.log( 'Failed to build ui-user-list!' );
      console.log( '\n\n' );
   };// /onBuildFail()
   ...
   oJobBuild.addTask( 'jsify', function(){
      // Jsify and minify.
      return jsify( bob.resolve( './src/ui-user-list.htm' ), true )
      .then(function( cResult ){
         ...
         return write( bob.resolve( './temp/ui-user-list-htm.js' ), cJs );
      });
   });
   ...
   oJobBuild.addTask( 'concat', function(){
      ...
      return Q.all([
         ...
         copy( bob.resolve('./src/ui-user-list.css' ), bob.resolve( './build' ) ),



         concat( [

            bob.resolve( './temp/ui-user-list-htm.js' ),
            bob.resolve( './src/ui-user-list.js' ),
         ], bob.resolve( './build/ui-user-list.js' ), {
